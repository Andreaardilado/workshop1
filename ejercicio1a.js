...
console.log("Sueldo inferior a 2000 US y antiguedad igual o superior a 10 años: " + ejercicioa)

// Ejercio 1.b 
// prueba 1 -> sueldo 3000 y antiguedad 10
const antiguedadmenor10 = Number(antiguedad) < 10 //F
const ejerciciob = sueldoInferior2000 || antiguedadmenor10  // F || F = F
console.log("Sueldo inferior a 2000 US o su antiguedad es menor a 10 años: "+ ejerciciob)

//Ejercicio 1.c
// prueba 1 -> sueldo 3000 y antiguedad 10
const ejercicioc = !sueldoInferior2000
console.log("Sueldo mayor o igual a 2000 US: "+ejercicioc)